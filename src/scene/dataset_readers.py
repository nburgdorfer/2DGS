...
from src.scene.colmap_loader import read_extrinsics_text, read_intrinsics_text, qvec2rotmat, read_extrinsics_binary, read_intrinsics_binary, read_points3D_binary, read_points3D_text
...
def readSFMCameras(cam_extrinsics, cam_intrinsics, images_folder):
    cam_infos = []
...
def fetchPly(path, voxel_size=0.5):
