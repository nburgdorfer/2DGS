...
class Camera(nn.Module):
    def __init__(self, colmap_id, cam, R, T, FoVx, FoVy, focal_x, focal_y, cx, cy, image, gt_alpha_mask,
        ...
        self.projection_matrix = getProjectionMatrixShift(self.znear, self.zfar, self.focal_x, self.focal_y, self.cx, self.cy, self.image_width, self.image_height, self.FoVx, self.FoVy).transpose(0,1).cuda()
